...
class CalendarTest(unittest.TestCase):
    ...
    def test_kday_on_or_before(self):
        ...
        tt = [
            {"date": date(2019, 6, 27), "js": Jours.JEUDI, "k": Jours.LUNDI, "kday": date(2019, 6, 24), },
            {"date": date(2019, 6, 27), "js": Jours.JEUDI, "k": Jours.MARDI, "kday": date(2019, 6, 25), },
            {"date": date(2019, 6, 27), "js": Jours.JEUDI, "k": Jours.MERCREDI, "kday": date(2019, 6, 26), },
            {"date": date(2019, 6, 27), "js": Jours.JEUDI, "k": Jours.JEUDI, "kday": date(2019, 6, 27), },
            {"date": date(2019, 6, 27), "js": Jours.JEUDI, "k": Jours.VENDREDI, "kday": date(2019, 6, 21), },
    ...
    def test_iso_date(self):
        ...
        tt = [
            ...
            {"g_date": GDate(12, 31, 2006), "iso_date": ISODate(52, 7, 2006), },
            {"g_date": GDate(1, 1, 2007), "iso_date": ISODate(1, 1, 2007), },
            {"g_date": GDate(12, 30, 2007), "iso_date": ISODate(52, 7, 2007), },
            {"g_date": GDate(12, 31, 2007), "iso_date": ISODate(1, 1, 2008), },
            {"g_date": GDate(1, 1, 2008), "iso_date": ISODate(1, 2, 2008), },
            {"g_date": GDate(12, 29, 2008), "iso_date": ISODate(1, 1, 2009), },
            {"g_date": GDate(12, 31, 2008), "iso_date": ISODate(1, 3, 2009), },
            {"g_date": GDate(1, 1, 2009), "iso_date": ISODate(1, 4, 2009), },
            {"g_date": GDate(12, 31, 2009), "iso_date": ISODate(53, 4, 2009), },
    ...
    def test_julian_date(self):
        ...
        tt = [
            ...
            {"g_date": GDate(8, 11, -3113), "j_date": JDate(9, 6, -3114), },
            {"g_date": GDate(1, 23, -3101), "j_date": JDate(2, 18, -3102), },
            {"g_date": GDate(2, 15, -2636), "j_date": JDate(3, 8, -2637), },
            {"g_date": GDate(12, 30, 0), "j_date": JDate(1, 1, 1), },
            {"g_date": GDate(1, 1, 1), "j_date": JDate(1, 3, 1), },
            {"g_date": GDate(8, 27, 7), "j_date": JDate(8, 29, 7), },
            {"g_date": GDate(8, 29, 284), "j_date": JDate(8, 29, 284), },
            {"g_date": GDate(3, 22, 622), "j_date": JDate(3, 19, 622), },
            {"g_date": GDate(7, 19, 622), "j_date": JDate(7, 16, 622), },
            {"g_date": GDate(9, 22, 1792), "j_date": JDate(9, 11, 1792), },
        ...
        paques = [
            ...
            {"g_paques": GDate(4, 21, 2019), "j_paques": GDate(4, 28, 2019), "h_paques": GDate(4, 20, 2019), },
            {"g_paques": GDate(4, 12, 2020), "j_paques": GDate(4, 19, 2020), "h_paques": GDate(4, 9, 2020), },
            {"g_paques": GDate(4, 4, 2021), "j_paques": GDate(5, 2, 2021), "h_paques": GDate(3, 28, 2021), },
            {"g_paques": GDate(4, 17, 2022), "j_paques": GDate(4, 24, 2022), "h_paques": GDate(4, 16, 2022), },
            {"g_paques": GDate(4, 9, 2023), "j_paques": GDate(4, 16, 2023), "h_paques": GDate(4, 6, 2023), },
            {"g_paques": GDate(3, 31, 2024), "j_paques": GDate(5, 5, 2024), "h_paques": GDate(4, 23, 2024), },
            {"g_paques": GDate(4, 20, 2025), "j_paques": GDate(4, 20, 2025), "h_paques": GDate(4, 13, 2025), },
        ]
    ...
    def test_coptic_date(self):
        ...
        tt = [
            ...
            {"year": 2017, "g_date": GDate(1, 7, 2017), },
            {"year": 2018, "g_date": GDate(1, 7, 2018), },
            {"year": 2019, "g_date": GDate(1, 7, 2019), },
            # {"year":2020, "g_date":GDate(1, 7, 2020),},
            {"year": 2021, "g_date": GDate(1, 7, 2021), },
            {"year": 2022, "g_date": GDate(1, 7, 2022), },
            {"year": 2023, "g_date": GDate(1, 7, 2023), },
